const projectData = [
    ...
    },
    {
        id: 4,
        name: 'Burger Tracker',
        imgSrc: 'https://i.ibb.co/G2M9MD7/project4.png',
        description: 'Server app to track and update a burger list.',
        codeSrc: 'https://github.com/PhilipLemaster/Node-Express-Handlebars',
        responsibilites: 'HTML/CSS, Node.js, mySQL, Express.js, Handlebars, Bootstrap'
    },
    {
        id: 5,
